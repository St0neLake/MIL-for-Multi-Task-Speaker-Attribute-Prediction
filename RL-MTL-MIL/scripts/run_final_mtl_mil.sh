...
# ---- Multi-Task MIL Single Run Configuration ----
# This script executes a single pre-tuning run for the base MIL model for MTL
# with a specific set of hyperparameters.

# --- Fixed Parameters for this Run ---
BASELINE_TO_TUNE="MeanMLP"
...
EPOCHS=800
HIDDEN_DIM=64
LEARNING_RATE=1.1978242362931615e-05
SCHEDULER_PATIENCE=5
EARLY_STOPPING_PATIENCE=50

# --- WandB Configuration ---
WANDB_ENTITY="stonelake-university-of-amsterdam"
WANDB_PROJECT="MIL_MTL_Final_run" # Project for MIL pre-tuning runs
...
LOG_FILE_PATH="run_log_${SESSION_NAME}_$(date +%s).txt"
